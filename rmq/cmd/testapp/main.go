...
func main() {
	...
	tests.Get(host, "events_for_day?day=2020-01-07", http.StatusOK, 0)
	tests.Get(host, "events_for_day?day=2020-01-10", http.StatusOK, 1)
	tests.Get(host, "events_for_week?week=2020-02", http.StatusOK, 2)
	tests.Get(host, "events_for_month?month=2020-01", http.StatusOK, 3)
}
